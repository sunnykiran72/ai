"""
================================================================================
DEPRECATION NOTICE - LEGACY MONOLITHIC MAIN.PY
================================================================================

This file is a preserved copy of the original monolithic main.py (14,257 lines)
created during the refactoring process. It is kept for reference and rollback
purposes only.

**DO NOT USE THIS FILE FOR ACTIVE DEVELOPMENT**
...
- core/       - AI model runners
- modules/    - Feature modules
- shared/     - Cross-cutting concerns

For active development, use main.py and the modular structure.

================================================================================
ROLLBACK PROCEDURE
================================================================================

If you need to rollback to the legacy monolithic version:

1. Backup the current refactored code:
   $ cp main.py main_refactored.py
   $ tar -czf refactored_backup_$(date +%Y%m%d_%H%M%S).tar.gz config/ services/ utils/ routes/

2. Restore the legacy version:
   $ cp main_legacy.py main.py

3. Remove or archive the refactored modules:
   $ mkdir -p .archive/refactored_$(date +%Y%m%d_%H%M%S)
   $ mv config/ services/ utils/ routes/ .archive/refactored_$(date +%Y%m%d_%H%M%S)/

4. Restart the application:
   $ # Use your normal startup procedure

5. Verify functionality:
   $ # Run your test suite or smoke tests

IMPORTANT: After rollback, investigate the issue that required the rollback
and document it before attempting the refactoring again.
...
raise RuntimeError(
    "main_legacy.py is disabled for dependency auditing. "
    "Use the refactored modules under config/, services/, utils/, and routes/."
)
