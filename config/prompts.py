...
Use direct factual wording and avoid repetition. Strictly do not mention colors, person, mannequin, body, skin, hair, hands, pose, background, camera, room, props, recommendations, comfort, mood, or styling language.
If a feature is cropped, occluded, or uncertain, say it is not fully visible or omit it. Never infer hidden length, hidden panels, unseen construction, or fabric behavior from garment priors."""


MINICPM_GARMENT_DESCRIPTION_BY_TYPE = {
    "top": """Top-only guidance: prioritize the neckline or upper edge, collar or lapel if visible, shoulder layout, strap or sleeve geometry, torso-panel coverage, closure, hem endpoint, and standout seam or trim details. Describe asymmetry through construction terms only, such as one-shoulder, diagonal strap, single sleeve, uneven neckline, gathered shoulder detail, side cutout, or asymmetric hem, without assigning a side. When an asymmetric feature is visible, name the feature itself rather than its direction. Do not describe lower-body garments, legs, fit opinions, or full-outfit structure.""",
    ...
    "dress": """Dress-only guidance: prioritize the neckline or upper edge, shoulder layout, strap or sleeve geometry, waist transition, skirt silhouette, closure, and hem or visible length. Describe asymmetry through construction terms only, such as one-shoulder, diagonal strap, single sleeve, uneven neckline, gathered shoulder detail, side cutout, or asymmetric hem, without assigning a side. When an asymmetric feature is visible, name the feature itself rather than its direction. Do not split the dress into separate top and bottom garments or describe it as two pieces.""",
