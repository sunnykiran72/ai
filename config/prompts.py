...
Strictly return one single precise garment-construction paragraph of 40 to 90 words only, plain text only, not JSON, not schema, not label list, and not caption.
Use only visible reconstruction-relevant facts: garment category, upper edge or waistband, shoulder or strap or sleeve layout, panel coverage, closure, hem or visible length, seam or panel structure, and trims or texture only when clearly visible.
Use direct factual wording and avoid repetition. Keep the paragraph dense with visible construction facts only. Prefer 4 to 7 high-value visible facts instead of trying to describe everything. This description is for recreating a garment-only product image, so describe only garment structure and visible garment details. Do not add fluff, generic summary phrases, fit opinions, styling language, or unsupported category upgrades. Strictly do not mention colors, person, mannequin, body, skin, hair, hands, pose, background, camera, room, props, recommendations, comfort, mood, or styling language. Never mention exposed human features behind the garment such as leg, arm, torso, chest, neck, shoulder, hand, or skin; when an opening, slit, cutout, or low neckline is visible, describe only the garment opening itself.
If a feature is cropped, occluded, or uncertain, say it is not fully visible or omit it. Never infer hidden length, hidden panels, unseen construction, or fabric behavior from garment priors. Do not use directional wording such as left, right, front, back, one side, opposite side, viewer-left, or viewer-right."""


MINICPM_GARMENT_DESCRIPTION_BY_TYPE = {
    "top": """Top-only guidance: prioritize facts in this order: dominant top category, visible upper edge shape or neckline or front opening, shoulder panel coverage, shoulder layout, strap or sleeve count and construction, bust or underbust or torso panel continuity, closure type and placement, hem endpoint, and one or two standout construction details when clearly visible. Strong detail candidates include wrap front, crossover front, tie-front, center knot, placket, button stand, ruched center front, gathered bust seam, corset seaming, cutout, peplum, ribbing, scalloped edge, openwork, crochet, lace trim, layered panel, overlay, or asymmetric hem. Mention decorative motif or surface pattern only when it changes the garment construction, edge finish, openwork, or panel structure; otherwise skip it. Do not mention motif colors. Describe asymmetry through construction terms only, such as one-shoulder, diagonal strap, single sleeve, mismatched strap count, uneven neckline, offset opening, gathered shoulder detail, side cutout, or asymmetric hem, without assigning a side. When an asymmetric feature is visible, name the feature itself rather than its direction. Use the most conservative top label when the subtype is ambiguous. Prefer generic labels such as top, knit top, tie-front top, or cropped top over stronger subtype labels unless the subtype is visually explicit. Do not describe lower-body features, full-outfit structure, fit opinions, or inferred fabric behavior.""",
    "bottom": """Bottom-only guidance: prioritize the waistband, rise, closure, pockets if visible, hip-to-leg or skirt shape, seam or panel structure, and hem or visible length. If the lower hem is cut off or obscured, say that the full length is not fully visible instead of guessing knee, ankle, or full-length coverage. Do not describe upper-body garments, sleeves, collars, shoulders, or neckline details.""",
    "dress": """Dress-only guidance: prioritize facts in this order: dominant dress category, visible upper edge shape or neckline, shoulder layout, strap or sleeve geometry, continuous bodice-to-skirt transition as one garment, waist transition, skirt silhouette or volume, opening or slit or cutout if visible, closure only when directly visible, and hem or visible length. Strong detail candidates include strapless upper edge, corset seaming, ruched torso, cutout, draped waist, layered skirt, ruffled skirt panels, cascading panels, high-low hem, train, and asymmetric hem. Describe asymmetry through construction terms only, such as one-shoulder, diagonal strap, single sleeve, uneven neckline, gathered shoulder detail, side cutout, asymmetric slit, cascading ruffle placement, or asymmetric hem, without assigning a side. When an asymmetric feature is visible, name the feature itself rather than its direction. For a slit or cutout, describe only the slit or cutout itself and never describe the body area revealed through it. Prefer describing the dress as one continuous garment. Do not split the dress into separate top and bottom garments, do not describe it as two pieces, and do not recast the lower portion as a separate skirt. Do not mention hidden back closures, hidden rear construction, or unseen opposite-side details. Stop after the highest-value visible construction facts are covered.""",
    "outer": """Outerwear-only guidance: prioritize the collar or lapel, opening, closure, shoulder structure, sleeve length, pockets if visible, and hem or visible length. If the lower hem is not fully visible, say that the outerwear length is partially visible or not fully visible instead of guessing hidden length. Do not describe inner garments as part of the outerwear.""",
}
